      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="mb-2">Teléfono: 1111111111</p>
            <p>Email: contacto@fmichimundo.com</p>
          </div>

          {/* Suscripción al Newsletter */}
          <div>
            <h2 className="text-xl font-bold mb-4">Suscríbete</h2>
            <p className="mb-4">Recibe nuestras ofertas y noticias felinas en tu correo.</p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p>&copy; {new Date().getFullYear()} MichiMundo. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  );
